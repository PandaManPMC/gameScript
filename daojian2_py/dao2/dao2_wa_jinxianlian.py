...
def gather_cao(hwnd):
    ...
    counter = 0
    # 二维数组，第一个点 表示中转点
    position = ["439,1201", "425,1261", "566,1373", "657,1324", "717,1186",
                "710,1087", "731,974", "679,858", "604,720", "436,692"]
    position_delay = [5, 9, 16, 14, 15,
                      11, 12, 12, 14, 14]
    ...
    while counter < MAX_COUNT:
        ...
        dh_count = 0
        while is_run:
            dh_xy = dao2_common.find_wu_jin_xian_lian_list(hwnd)
            if None is dh_xy:
