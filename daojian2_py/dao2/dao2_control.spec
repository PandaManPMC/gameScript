...
a = Analysis(
    ...
    pathex=[],
    binaries=[],
    datas=[('img/*', 'img'), ('D:\\a\\codes\\game_script\\pythonProject\\.venv\\Lib\\site-packages\\paddleocr', './paddleocr'), ('D:\\a\\codes\\game_script\\pythonProject\\.venv\\Lib\\site-packages\\paddle', './paddle')],
