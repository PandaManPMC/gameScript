...
def gather_cao(hwnd):
    ...
    counter = 0
    # 二维数组，第一个点 表示中转点
    position = ["1562,899", "1612,897", "1640,878", ["1629,880", "1652,840"], "1634,798",
                "1596,805", "1585,743", "1657,735", "1697,723"]
    position_delay = [28, 8, 9, 8, 19,
                      8, 8, 9, 12]
    ...
    while counter < MAX_COUNT:
        ...
        dh_count = 0
        while is_run:
            dh_xy = dao2_common.find_wu_chai_hu_list(hwnd)
            if None is dh_xy:
