...
def auto_zhenyingzhan():
    ...
    with LOCK_GLOBAL_UI:
        shanhetuzhi.is_run_auto_zhenyingzhan = not shanhetuzhi.is_run_auto_zhenyingzhan
        gamelib.log3.console(f"shanhetuzhi.is_run_auto_zhenyingzhan {shanhetuzhi.is_run_auto_zhenyingzhan}")

        if shanhetuzhi.is_run_auto_zhenyingzhan:
            btn_auto_zhenyingzhan.config(bg="red")
            t = threading.Thread(target=shanhetuzhi.run_auto_zhenyingzhan, args=(), daemon=True)
            t.start()
        else:
...
def auto_longzhuashou():
    ...
    with LOCK_GLOBAL_UI:
        shanhetuzhi.is_run_auto_longzhuashou = not shanhetuzhi.is_run_auto_longzhuashou
        gamelib.log3.console(f"shanhetuzhi.is_run_auto_longzhuashou {shanhetuzhi.is_run_auto_longzhuashou}")
