...
def is_mp(hwnd):
    ...
    y_of = int(app_const.screen_h * 0.85) + 65
...
def is_hp(hwnd):
    ...
    bo_w = int(app_const.screen_w * 0.6)
    bo_h = app_const.screen_h - 40
    return bg_find_pic_area.find_image(hwnd, win_tool.resource_path("img/hp.bmp"), x_of, y_of, bo_w, bo_h, 0.8)
